    ...
    <div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox ID="txtbusqCedula" runat="server" ValidationGroup="cedula" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            ...
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox ID="txtbusqNombre" runat="server" ValidationGroup="nombre" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
