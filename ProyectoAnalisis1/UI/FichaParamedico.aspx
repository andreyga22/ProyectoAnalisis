    ...
    <div class="container">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-sm-6">
                ...
                <label for="presionText">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="temperaturaText" ErrorMessage="Solo se permiten números con coma" ValidationExpression="^[0-9]{1,3}([,][0-9]{1,2})?$" ValidationGroup="guardarParam" ForeColor="Red"></asp:RegularExpressionValidator>
                </label>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="estaturaText" ErrorMessage="Solo se permiten números con coma" ValidationExpression="^[0-9]{1,3}([,][0-9]{1,2})?$" ValidationGroup="guardarParam" ForeColor="Red"></asp:RegularExpressionValidator>
            ...
            <div class="form-group col-sm-6">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="pesoText" ErrorMessage="Solo se permiten números con coma" ValidationExpression="^[0-9]{1,3}([,][0-9]{1,2})?$" ValidationGroup="guardarParam" ForeColor="Red"></asp:RegularExpressionValidator>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                <label for="Frec_RespText">
                    ...
                    <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="Frec_RespText" ErrorMessage="Solo se permiten números" ValidationExpression="\d*\.?\d*" ValidationGroup="guardarParam" ForeColor="Red"></asp:RegularExpressionValidator>--%>
                </label>
