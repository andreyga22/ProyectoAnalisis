    ...
    <div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="presionText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="temperaturaText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="estaturaText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="pesoText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
            <div class="form-group col-sm-6">
                <label for="imcText">IMC</label>
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="lastNameText2"></asp:RequiredFieldValidator>--%>
                <asp:TextBox type="text" class="form-control" ID="imcText"  runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="glicemiaText" runat="server"  BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            ...
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="oximetriaText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                <asp:TextBox type="text" class="form-control" ID="GlasgowText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
            ...
            <div class="form-group col-sm-6">
                ...
                &nbsp;<%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="phoneText" ErrorMessage="Campo Requerido"></asp:RequiredFieldValidator>--%><asp:TextBox type="text" class="form-control" ID="Frec_CardText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                ...
                &nbsp;<%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="phoneText" ErrorMessage="Campo Requerido"></asp:RequiredFieldValidator>--%><asp:TextBox type="text" class="form-control" ID="Frec_RespText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>

            <div class="form-group col-sm-6">
                <label for="PupilasText">Pupilas</label>
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="phoneText" ErrorMessage="Campo Requerido"></asp:RequiredFieldValidator>--%>
                <asp:TextBox type="text" class="form-control" ID="PupilasText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="phoneText" ErrorMessage="Campo Requerido"></asp:RequiredFieldValidator>--%>
            <asp:TextBox type="text" class="form-control" ID="PielText" runat="server" BorderColor="#16ACB8" BorderStyle="Solid"></asp:TextBox>
        </div>
